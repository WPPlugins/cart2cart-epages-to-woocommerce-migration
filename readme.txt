...
Tags: ePages to woocommerce, ePages to woocommerce migration, migrate ePages to woocommerce
Requires at least: 3.5.1
Tested up to: 4.7.4
Stable tag: 4.0
License: GPLv2
License URI: http://www.gnu.org/licenses/gpl-2.0.html
Plugin helps to migrate all data from ePages to WooCommerce automatically with no programming skills required.

== Description ==
**Supported WooCommerce versions: 1.1.x – 1.6.x, 2.x, 3.x**

The plugin will help you to migrate all your data from ePages to WooCommerce automatically. You will be able to transfer products, customers, orders with all corresponding information accurately and effortlessly.
...
= The following entities can be moved from ePages to WooCommerce:
 =
...
**Note.** *Plugin supports entities migration only, ePages theme won’t be converted into WooCommerce theme.This plugin installs connection bridges at your ePages and WooCommerce, which is needed for data interaction between two platforms. Upon activation, you’ll be redirected to Cart2Cart website in order to launch the conversion.*

= Steps to Take before Migration =
1. Install WooCommerce and make sure that ePages and WooCommerce stores are available online.
1. Have ePages store FTP access details at hand (host, username, password) - you use them to install connection bridge on ePages.
...
1. Go to Admin -> Go to Admin -> Plugins, find “Cart2Cart ePages to WooCommerce Migration” and click Activate
...
Yes, Cart2Cart supports migration of multiple languages from ePages to WooCommerce providing a paid WPML module is installed and configured on your WordPress before the data transfer. Please, [read our FAQ](https://www.shopping-cart-migration.com/faq/45-woocommerce/385007-is-multilanguage-migration-to-from-woocommece-possible) for more info.
= Will customers' passwords be migrated? =
As diverse platforms use different password encryption algorithm, clients’ passwords cannot be migrated. Once the transfer process is finished all registered clients will have to use password recovery form on the target platform for further usage their profiles.
= Does migration influence the speed of my store? =
The migration process doesn’t influence the speed of your store performance. Needless, to say a newly established store without data will work faster than a store with thousands of products, orders and customers.
= Can I migrate product and category SEO URLs? =
Yes, you can migrate product and category SEO URLs from ePages to WooCommerce. To do this, you need to choose it in Additional Options.
= Will my current ePages function during the migration? =
